...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  },
  {
    ...
    header: "Profiles",
    cell: ({ row }) => (
      <div className="font-medium">{row.original.profile}</div>
    ),
    enableHiding: false,
  },
  {
      ...
      return (
        ...
        >
          {status === "Active" ? (
            ...
            <TbAlertCircle className="text-yellow-600 dark:text-yellow-400" />
          ) : (
            <TbCircleX className="text-red-500 dark:text-red-400" />
          )}
          {status}
        </Badge>
      );
    ...
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="flex items-center justify-between px-4">
        <div className="text-muted-foreground hidden flex-1 text-sm lg:flex">
          {table.getFilteredRowModel().rows.length} profile(s) total.
        </div>
